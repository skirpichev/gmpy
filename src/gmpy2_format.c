...
"The default format is like 'g', except that when fixed-point notation\n"
"is used to format the result, it always includes at least one digit\n"
"past the decimal point, and switches to the scientific notation when\n"
"formatted exponent > precision.  When the precision is not specified,\n"
"the latter will be as large as needed to represent the given value\n"
"faithfully.");
